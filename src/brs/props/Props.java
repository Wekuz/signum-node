...
public class Props {
    ...
    public static final Prop<String> DB_URL = new Prop<>("DB.Url",
            "jdbc:h2:file:./db/signum-v2;DB_CLOSE_ON_EXIT=FALSE");
    ...
    // gRPC P2P options
    public static final Prop<Boolean> P2P_GRPC_ENABLE = new Prop<>("P2P.GrpcEnable", true);
    public static final Prop<Integer> P2P_GRPC_PORT = new Prop<>("P2P.GrpcPort", 8127);
    public static final Prop<Boolean> P2P_GRPC_GZIP_ENABLED = new Prop<>("P2P.GrpcGzipEnabled", true);
